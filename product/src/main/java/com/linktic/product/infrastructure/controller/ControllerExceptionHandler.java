...
import com.linktic.product.infrastructure.controller.dto.MessageResponse;
...
public class ControllerExceptionHandler {
    ...
    protected ResponseEntity<MessageResponse> handleProductNotFoundExceptionException(ProductNotFoundException e) {
        log.error(e.getMessage(), e);
        var messageResponse = MessageResponse.builder()
                .withMessage(e.getMessage())
